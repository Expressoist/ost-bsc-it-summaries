...
. Für jeden Punkt:
    .. Zeichne eine Linie zu den *2* vorherigen Punkten, für die gilt:
        ...
        ** Keine Überschneidungen [.not-in-cheatsheet]#entstehen#
...
. Für alle Punkte (zufällige Wahl):
    .. Bestimme [.not-in-cheatsheet]#das# umfassende Dreieck.
    .. Unterteile dieses Dreieck in 3 weitere Dreiecke. D.h. Verbinde alle Eckpunkte mit dem [.not-in-cheatsheet]#gewählten# Punkt.
. Wiederhole, bis zum Ende.
...
. Betrachtungshöhe [.not-in-cheatsheet]#(Potenzial)# festlegen.
. Für alle Quadrate im Gitter:
    .. Eckpunkte beachten.
    .. Nach Schema [.not-in-cheatsheet]#unten# Linien einzeichnen.
. Wiederhole, bis zum Ende.
