...
==== HDR & HDRI
Ein «High Dynamic Range Image» ist ein 360°-Bild für Belichtung- und Hintergrundzwecken. HDR-Bilder werden durch das Zusammensetzen von mehreren Bildern der gleichen Scene mit jeweils anderer Belichtung erzeugt.
