...
[.not-in-cheatsheet]
Um das Problem der Translation zu lösen, werden alle kartesischen Koordinaten [.smaller]#stem:[P(x,y)]# auf homogene Koordinaten [.smaller][.line-through]#####stem:[P_H(x,y,1)]# abgebildet.
